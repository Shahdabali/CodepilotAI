...
export const config = {
  ...
  nvidiaApiKey: process.env.NVIDIA_NIM_API_KEY ?? process.env.NVIDIA_API_KEY ?? '',
  nvidiaBaseUrl: process.env.NVIDIA_NIM_BASE_URL ?? process.env.NVIDIA_BASE_URL ?? 'https://integrate.api.nvidia.com/v1',
  nvidiaModel: process.env.NVIDIA_NIM_MODEL ?? process.env.NVIDIA_MODEL ?? 'nvidia/llama-3.1-nemotron-70b-instruct',
